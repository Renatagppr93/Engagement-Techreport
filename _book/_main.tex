...
\author{Eagle I.O}
\date{Most recently updated 2022-04-08}
...
This report was written with \texttt{bookdown} \citep{R-bookdown} within \texttt{rMarkdown} \citep{R-markdown} using \texttt{R} version 4.1.3 \citep{R-base}.
...
\hypertarget{analyses-scale-definitions}{%
\chapter{Analyses (Scale Definitions)}\label{analyses-scale-definitions}}
...
We used \texttt{lavaan} version 0.6.11 \citep{R-lavaan} and \texttt{semPlot} version 1.1.5 \citep{R-semPlot}
...
\includegraphics{correlation.jpg}
...
\hypertarget{completed-projects-as-of-april-08-2022}{%
\section{Completed projects as of April 08, 2022}\label{completed-projects-as-of-april-08-2022}}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/geo-1.pdf}
...
\includegraphics{_main_files/figure-latex/modindices-1.pdf}
