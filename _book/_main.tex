...
\author{Eagle I.O}
\date{Most recently updated 2021-08-28}
...
This report was written with \texttt{bookdown} \citep{R-bookdown} within \texttt{rMarkdown} \citep{R-markdown} using \texttt{R} version 4.1.1 \citep{R-base}.
...
We used \texttt{lavaan} version 0.6.9 \citep{R-lavaan} and \texttt{semPlot} version 1.1.2 \citep{R-semPlot}
