...
\author{Eagle I.O}
\date{Most recently updated 2022-03-24}
...
In addition to the below interactive plot {[}via \texttt{plotly} version 4.9.2.1; \citet{R-plotly}{]}, a full inter-item correlation matrix is located in Appendix \ref{corrs}.
...
\begin{longtable}[]{@{}llllllll@{}}
\toprule
18-Item Model & \(\chi^2\) & \emph{df} & RMSEA & SRMR & CFI & TLI & AIC \\
\midrule
\endhead
...
\hypertarget{completed-projects-as-of-march-24-2022}{%
\section{Completed projects as of March 24, 2022}\label{completed-projects-as-of-march-24-2022}}
