...
| substantive (sub priority)|`r Final2.1[3,2]`  |`r Final2.1[4,2]`  |`r Final2.1[23,2]`  |`r Final2.1[29,2]`  |`r Final2.1[9,2]`  |`r Final2.1[10,2]`  |`r Final2.1[19,2]`  |
| attitudinal (sub priority)|`r Final2.2[3,2]`  |`r Final2.2[4,2]`  |`r Final2.2[23,2]`  |`r Final2.2[29,2]`  |`r Final2.2[9,2]`  |`r Final2.2[10,2]`  |`r Final2.2[19,2]`  |
| bifactor (sub priority)   |`r Final.mod2[3,2]`|`r Final.mod2[4,2]`|`r Final.mod2[23,2]`|`r Final.mod2[29,2]`|`r Final.mod2[9,2]`|`r Final.mod2[10,2]`|`r Final.mod2[19,2]`|
...
# Analyses (Construct and Criterion-related Validation)

![](correlation.jpg)

For convergent validity indices, we administered the 17-item Utrecht Work Engagement Scale [UWES; @schaufeli_measurement_2002; @schaufeli_defining_2010] as well as the @saks2006antecedents 12-item scale which aggregates to two scales: job and organizational engagement. [^gsux]
