...
library(plotly)
ggplotly(cor.plot) ## trying frameWidget so plot renders better on phone (didn't work: 6/17/21)
...
#####Final Scale Definition (18 items Casey's item reduction method)
